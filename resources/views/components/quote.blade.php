<section
    class="relative isolate overflow-hidden bg-gray-900 px-6 py-24 sm:py-32 mt-32 lg:px-8"
>
    <!-- <div
    ...
    >
        <div
            class="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-r from-blue-500 to-[#776fff] opacity-[0.35]"
    ...
    >
        <div
            class="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-r from-blue-500 to-[#776fff] opacity-25"
            style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"
        >
        </div>
    </div>

    <div class="mx-auto max-w-2xl lg:max-w-4xl relative">
        <figure>
            <blockquote
                class="text-center text-xl leading-8 text-white sm:text-2xl sm:leading-9 font-serif"
            >
                <p>
            ...
            <figcaption class="mt-10">
                <div class="mt-4 flex items-center justify-center space-x-3 text-base">
                    <div class="font-semibold text-white">Matthew 11:28-30</div>
                    <svg
                        viewBox="0 0 2 2"
                        width="3"
                        height="3"
                    ...
                    <div class="text-gray-300">Authorized Version</div>
                </div>
            </figcaption>
        </figure>
    </div>
